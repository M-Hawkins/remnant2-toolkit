...
export function Footer() {
  return (
    <footer className="mt-8 flex w-full items-center justify-center border-t border-secondary bg-background-container p-4 text-left text-sm text-on-background-variant">
